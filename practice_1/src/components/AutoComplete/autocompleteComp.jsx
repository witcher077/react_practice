...
//         if (value !== "") {
//             const filteredCounties = Countries.filter((ele) => ele.name.includes(value))
...
//         const id = setTimeout(() => { updatesuggestions(inputVal) },5000)
...
const Autocomplete = () => {
    ...
    }, [debouncedInput]) // only updates when debouncedInput changes
